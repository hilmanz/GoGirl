...
;
	...
	<!--- END ---->
<script type="text/javascript" src="<?php echo $this->_tpl_vars['basedomain']; ?>
admin/jscripts/tiny_mce/tiny_mce.js"></script>
<!--	<script type="text/javascript" src="<?php echo $this->_tpl_vars['basedomain']; ?>
assets/js/tinymce/js/tinymce/tinymce.min.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo $this->_tpl_vars['basedomain']; ?>
assets/js/tinymce/FileBrowser.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo $this->_tpl_vars['basedomain']; ?>
assets/js/tinymce/FileChooser.js"></script>
<script  language="javascript" type="text/javascript" src="<?php echo $this->_tpl_vars['basedomain']; ?>
assets/js/tinymce/ImageChooser.js"></script>
 -->
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['basedomain']; ?>
