<?php /* Smarty version 2.6.13, created on 2015-05-06 15:27:27
         compiled from application/admin//apps/listcomment.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'application/admin//apps/listcomment.html', 85, false),)), $this); ?>
<script>
<?php echo '
...
?>
			...
			<td><?php if ($this->_tpl_vars['list'][$this->_sections['i']['index']]['id_cerita'] == 1): ?>
			Style
			<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['id_cerita'] == 2): ?>
			Event
			<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['id_cerita'] == 3): ?>
			Skin
			<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['id_cerita'] == 4): ?>
			D.I.Y
			<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['id_cerita'] == 5): ?>
			Relations
			<?php endif; ?>
