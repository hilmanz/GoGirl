<?php /* Smarty version 2.6.13, created on 2015-05-06 15:20:48
...
relations/detail?param=<?php echo $this->_tpl_vars['listcontent'][$this->_sections['i']['index']]['id']; ?>
">
...
$(document).bind(\'scroll\',\'.galleryList\', function()
		...
		$.ajax({
		type: "POST",
		url: basedomain+\'relations/getrelation\',
		data: {start:start},
		dataType: "json",
		...
		$.each(result.data,function(k,v){  
		    ...
		    str+=\'<figcaption>\';
			str+=\'<a class="thumb thumb-medium" href="\'+basedomain+\'relations/detail?param=\'+v.id+\'">\';
			str+=\'<img src="\'+basedomain+\'public_assets/imgregistrasi/\'+v.img+\'"/>\';
			str+=\'</a>\';
		    str+=\'<h4><a href="\'+basedomain+\'relations/detail?param=\'+v.id+\'">\'+v.title+\'</a></h4>\';
			str+=\'<div class="meta-container">\';
			str+=\'<a href="\'+basedomain+\'relations/detail?param=\'+v.id+\'">\';
			...
			str+=\'<a class="fb-share" href="javascript:void(0)" onclick="shareFB(\'+v.titleshare+\',\'+basedomain+\'relations/detail?param=\'+v.id+\',\'+basedomain+\'relations/detail?param=\'+v.id+\',,\'+v.content.substring(0,50)+\')"><i class="icon-facebook">&nbsp;</i></a> \';
            ...
            str+=\'<p>\'+v.content+\'</p>\';
            str+=\'<a href="\'+basedomain+\'relations/detail?param=\'+v.id+\'" class="readmore"><i class="icon-arrow-right"></i></a>\';
