...
$CONFIG['DEFAULT_MODULES_ADMIN'] = "home";
$CONFIG['VIEW_ON']  = 1;
...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/gogirl-cnc/trunk/";
	$PUBLIC_HTML = "";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/gogirl-cnc/trunk/";
	$PUBLIC_HTML = "public_html/";
}
$CONFIG['BASE_DOMAIN_PATH'] = "http://localhost/gogirl-cnc/trunk/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "C:/xampp/htdocs/gogirl-cnc/trunk/public_html/public_assets/";

$CONFIG['LOCAL_ASSET'] = "C:/xampp/htdocs/gogirl-cnc/trunk/public_html/assets/";
...
$CONFIG['SESSION_NAME'] = "girl-2014_apps_2014";
